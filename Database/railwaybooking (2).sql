...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2021 at 08:29 AM
...
INSERT INTO `details` (`header_image`, `header_title`, `header_desc`, `subpage_image`, `book_image`) VALUES
('post-06.jpg', 'White Catchers Gift Wall decor', 'Order your foods', 'slide2.jpg', 'daniel-klein-Qx8_d5dGhrs-unsplash.jpg');
...
--
ALTER TABLE `booking`
  ADD CONSTRAINT `booking_ibfk_1` FOREIGN KEY (`sch_id`) REFERENCES `schedule` (`sch_id`),
...
ALTER TABLE `schedule`
  ...
  ADD CONSTRAINT `schedule_ibfk_2` FOREIGN KEY (`to_station`) REFERENCES `station` (`station_id`);

--
-- Constraints for table `seats_calculate`
--
ALTER TABLE `seats_calculate`
  ADD CONSTRAINT `seats_calculate_ibfk_1` FOREIGN KEY (`sch_id`) REFERENCES `schedule` (`sch_id`);

--
-- Constraints for table `unavailable`
--
ALTER TABLE `unavailable`
  ADD CONSTRAINT `unavailable_ibfk_1` FOREIGN KEY (`sch_id`) REFERENCES `schedule` (`sch_id`);

--
-- Constraints for table `user_backup`
--
ALTER TABLE `user_backup`
  ADD CONSTRAINT `user_backup_ibfk_1` FOREIGN KEY (`backup_id`) REFERENCES `user` (`user_id`);
COMMIT;
